...
echo "Copying /github/home/Steam/config/config.vdf..."
echo "$configVdf" > "/github/home/Steam/config/config.vdf"
...
echo "Copying /github/home/Steam/ssfn..."
echo "$ssfnFileContents" | base64 -d > "/github/home/Steam/$ssfnFileName"
chmod 777 "/github/home/Steam/$ssfnFileName"
